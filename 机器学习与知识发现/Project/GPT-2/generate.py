...
def main(prefix, platform = 'zhihu'):
    parser = argparse.ArgumentParser()
    parser.add_argument('--length', default=100, type=int, required=False, help='the length of the generated text')
    parser.add_argument('--nsamples', default=1, type=int, required=False, help='generate n samples')
    ...
    parser.add_argument('--topk', default=0, type=int, required=False, help='topk for beam search')
    parser.add_argument('--topp', default=0.8, type=float, required=False, help='max accumulation prob')
    ...
    parser.add_argument('--reptition_penalty', default=1.5, type=float, required=False)
    parser.add_argument('--platform', default=platform,choices=['zhihu', 'hupu', 'tieba'])
    ...
    topk = args.topk
    topp = args.topp
    repetition_penalty = args.reptition_penalty
